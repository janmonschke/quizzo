  ...
  const questions = await Promise.all([
    ...
    db.question.create({
      data: {
        ...
        quizId: quiz.id,
        questionText:
          "MICROSOFT ENCARTA: What is the only country of South America where English is the official language?",
        answer: "Guyana",
      },
    }),
    db.question.create({
      data: {
        ...
        answer: "TRUE (lava lamp random number generator at cloudflare)",
      },
    }),
    db.question.create({
      data: {
